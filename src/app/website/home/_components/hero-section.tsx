  ...
  return (
    <div className="relative flex min-h-dvh w-full items-end pt-16 sm:pt-20">
      ...
      <div className="relative z-10 container mx-auto flex flex-wrap min-h-0 w-full flex-col lg:flex-row items-stretch gap-6 lg:gap-0 px-4 sm:px-6 pb-8 sm:pb-10">
        ...
        {/* Left Content */}
        <div className="content order-2 lg:order-1 flex min-h-0 lg:w-1/2 w-full flex-col justify-center gap-5 sm:gap-6 pr-0 lg:pr-4">
          {/* Heading */}
          ...
          {/* Counters */}
          <div className="counter mt-4 sm:mt-7 grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6 lg:gap-8">
            <SolidButton className="px-8 sm:px-10">
