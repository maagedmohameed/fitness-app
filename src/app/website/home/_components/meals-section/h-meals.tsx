...
export default function Meals() {
  ...
  return (
    <section className="bg-[url(/assets/images/healthy-bg.webp)] bg-cover bg-center px-1 py-8 h-screen">
      {/* Section Head */}
      ...
      {/* Section Content */}
      <div className="flex flex-col items-center gap-8 bg-white/60 dark:bg-[#242424]/60 backdrop-blur-xl h-104">
        {/* SubTitle */}
        <SectionSubTitle variant={"center"}>{t("subTitle")}</SectionSubTitle>
        {/* Description */}
        <p className="w-[39.8rem] font-bold text-[#242424] dark:text-[#F3F3F4] text-4xl text-center uppercase leading-12">
          {t.rich("desc", {
