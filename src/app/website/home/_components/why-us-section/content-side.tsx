...
export default function ContentSide() {
  ...
  return (
    <div className="text-foreground">
      ...
      <p className="mt-6 mb-10 sm:mb-16 w-full max-w-146 font-rubik text-base sm:text-lg">
        {t("desc-2")}
      </p>
        ...
        {([1, 2, 3] as const).map(n => (
          <li key={n} className="flex items-center gap-4 sm:gap-10">
            <div className="shrink-0">
              <span className="flex justify-center items-center bg-[#FF4100] border border-[#24242424] rounded-full w-12 sm:w-14 h-12 sm:h-14 font-inter font-bold text-[#f3f3f4] text-xs sm:text-base">
                {locale === "en"
                  ? `0${n}`
                  : format.number(n, {
            ...
            <div className="space-y-2 min-w-0">
              ...
              <p className="font-rubik text-sm sm:text-base leading-relaxed">
                {t(`li-${n}-desc`)}
              </p>
            </div>
          </li>
