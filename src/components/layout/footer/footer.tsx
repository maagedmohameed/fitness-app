...
export default function Footer() {
  ...
  return (
    <footer className="gap-12 sm:gap-20 grid lg:grid-cols-4 bg-accent dark:bg-background mx-auto px-4 sm:px-6 py-10 md:p-20 md:pt-10 w-full text-foreground dark:text-foreground text-lg">
      {/* Brand / Tagline */}
